...
from .gpt import get_gpt_structured_response, get_gpt_streaming_response
from .grok import get_grok_structured_response, get_grok_streaming_response
from .llama import get_llama_streaming_response, get_llama_structured_response
from .gemini import get_gemini_structured_response, get_gemini_streaming_response
from .claude import get_claude_structured_response, get_claude_streaming_response

def get_model_response(model:str, user_prompt:str, sys_prompt:str, gen_type:str)->Union[NormalizedClaim, Feedback]:
    ...
    if model in ["gpt-4o-2024-11-20", "gpt-4.1-2025-04-14", "gpt-4.1-nano-2025-04-14"]:
        ...
        generated_claim = get_llama_streaming_response(model, sys_prompt, user_prompt) if gen_type == "chat" else get_llama_structured_response(model, sys_prompt, user_prompt, response_type)
