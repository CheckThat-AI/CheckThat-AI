...
const ExtractionResultsComponent: React.FC<ExtractionResultsProps> = ({ 
  results, 
  selectedModels, 
  ...
  if (isSingleSelection) {
    ...
    return (
      <div className="mt-8">
        <h3 className="text-lg font-medium text-slate-800 mb-4">Extraction Results</h3>
        <motion.div
...
export default ExtractionResultsComponent;