...
function LoginButton() {
  ...
  const { setMode, setUser } = useAppContext();
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setErrorMessage(error.message || 'Google OAuth login failed');
        setShowErrorOverlay(true);
      }
      
      // Note: The actual redirect happens automatically for OAuth flow
      // User info will be handled by the auth state change listener
      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-black to-gray-900">
        <div className="bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-8">Sign in to continue to your account</p>
